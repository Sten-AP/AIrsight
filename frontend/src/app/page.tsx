     ...
     <TabPanel>
      <Grid numItemsMd={2} numItemsLg={3} className="gap-6 mt-6">
       ...
       <Card>
        {/* Placeholder to set height */}
        {/* <div className="h-28" /> */}
        <iframe src="http://airsight.westeurope.cloudapp.azure.com:3002/d-solo/bb08a297-a2d9-458a-9d7c-06258271aec3/airsight?orgId=1&theme=light&panelId=3&refresh=10min" width="100%" height="200px"></iframe>
       </Card>
       <Card>
        {/* Placeholder to set height */}
        {/* <div className="h-28" /> */}
      ...
      <div className="mt-6">
       <Card>
        {/* Placeholder to set height */}
        {/* <div className="h-80" /> */}
        <iframe src="http://airsight.westeurope.cloudapp.azure.com:3002/d-solo/bb08a297-a2d9-458a-9d7c-06258271aec3/airsight?orgId=1&theme=light&panelId=1&refresh=60min" width="100%" height="200px"></iframe>
       </Card>
      </div>
     </TabPanel>
     <TabPanel>
